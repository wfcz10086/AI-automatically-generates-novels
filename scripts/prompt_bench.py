...
── 形制 ──
段落平均五十字上下。**不要每句话都单独成段**——意思连着的两三句放在同一段里，
只有需要砸出节奏的那一句才单独成段。最长的一段不要超过一百五十字。
正文 2500~3200 字，写满，不许提前收尾。
